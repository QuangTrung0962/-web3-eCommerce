...
const ProductChart = ({ products, review, cart, wishlist, paymentData }) => {
    ...
    const wishlistData = [
        {
            name: 'Cloths',
            'Quantity in wishlist': wishlist.filter((prod) => prod.productId.type === 'cloths')
                .length,
        },
        {
            name: 'Shoes',
            'Quantity in wishlist': wishlist.filter((prod) => prod.productId.type === 'shoe')
                .length,
        },
        {
            name: 'Electronics',
            'Quantity in wishlist': wishlist.filter((prod) => prod.productId.type === 'electronics')
                .length,
        },
        {
            name: 'Books',
            'Quantity in wishlist': wishlist.filter((prod) => prod.productId.type === 'book')
                .length,
        },
        {
            name: 'Jewelry',
            'Quantity in wishlist': wishlist.filter((prod) => prod.productId.type === 'jewelry')
                .length,
        },
    ];
    ...
    return (
        <>
            <Container sx={{ marginTop: 5 }}>
                ...
                <h3 style={{ textAlign: 'center', margin: '30px 0', color: '#e377c2    ' }}>
                    Users Wishlist
                </h3>
                <div style={{ width: '100%', height: 400 }}>
                    <ResponsiveContainer>
